...
311
notp centrality
sum [betweenness-centrality] of turtles
17
1
11
...
@#$#@#$#@
<experiments>
  <experiment name="small world-rngstandard-50-12prd" repetitions="100" runMetricsEveryStep="false">
    <setup>setup
discovery</setup>
    <go>go</go>
    ...
    <metric>mtrust_prd_count</metric>
    <metric>mtrust_std_count</metric>
  ...
  <experiment name="small world-rngstandard-100-12prd" repetitions="100" runMetricsEveryStep="false">
    <setup>setup
discovery</setup>
    <go>go</go>
    <metric>count turtles</metric>
    ...
    <metric>count turtles with [ p? = true]</metric>
    <metric>count turtles with [notp? = true]</metric>
    <metric>count mtrust_prd</metric>
    <metric>count mtrust_std</metric>
    <enumeratedValueSet variable="_network_type">
      <value value="&quot;small-world&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="discovery_type">
  ...
  <experiment name="small world-rngstandard-300-12prd" repetitions="100" runMetricsEveryStep="false">
    <setup>setup
discovery</setup>
    <go>go</go>
    <metric>count turtles</metric>
